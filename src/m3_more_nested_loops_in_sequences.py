...
def run_test_largest_number():
    ...
    # Test 4:
    expected = 53218906
    answer = largest_number([(634,123, 865),(125, 37, 234231, 53218906, 286),[123, -123412351230987123098, 234, 4121]])
    print('Expected and actual are:', expected, answer)
...
def run_test_largest_negative_number():
    ...
    expected = -10
    answer = largest_negative_number(
        [(-634, 123, -865), (125, 37, -234231, -10, 286), [123, -123412351230987123098, -234, 4121]])
    print('Expected and actual are:', expected, answer)
